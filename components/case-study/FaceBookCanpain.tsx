...
export default function FaceBookCampain(){
    return(
        <>
        <div className="flex mt-24 mx-5">
                <div className="w-1/2  flex items-center justify-center uppercase">
                        <h2 className={`${poppins.className} font-bold text-5xl`}>Targeting a Mature <span className="text-[#c20000] text-center">Demographic</span> <br/>on Facebook</h2>
                </div>
                <div className="w-1/2">
